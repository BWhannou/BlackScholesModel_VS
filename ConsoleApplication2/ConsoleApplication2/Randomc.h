...
***********************************************************************/
#include "UniGen.h"
class CRandomMersenne : public UniGen{                // Encapsulate random number generator
...
public:
   ...
   virtual void RandomInit(int seed);          // Re-seed
   virtual void RandomInitByArray(int const seeds[], int NumSeeds); // Seed by more than 32 bits
   virtual int IRandom (int min, int max);     // Output random integer
   int IRandomX(int min, int max);     // Output random integer, exact
   virtual double Random() ;                    // Output random float
   uint32_t BRandom();                 // Output random bits
private:
   virtual void Init0(int seed);               // Basic initialization procedure
...
class CRandomMother : public UniGen {                  // Encapsulate random number generator
public:
